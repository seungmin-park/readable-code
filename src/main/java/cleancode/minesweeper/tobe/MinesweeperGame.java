        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 10; col++) {
                ...
                if (!isLandMineCell(row, col)) {
                    ...
                    if (row - 1 >= 0 && col + 1 < 10 && isLandMineCell(row - 1, col + 1)) count++;
                    if (col - 1 >= 0 && isLandMineCell(row, col - 1)) count++;
                    if (col + 1 < 10 && isLandMineCell(row, col + 1)) count++;
                    if (row + 1 < 8 && col - 1 >= 0 && isLandMineCell(row + 1, col - 1)) count++;
                    if (row + 1 < 8 && isLandMineCell(row + 1, col)) count++;
                    if (row + 1 < 8 && col + 1 < 10 && isLandMineCell(row + 1, col + 1)) count++;
